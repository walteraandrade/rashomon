---
name: builder-ui
description: Implements the front-end part of an approved spec in public/atlas.html (or a new page when the spec says so), verified in a real browser. Never touches src/.
