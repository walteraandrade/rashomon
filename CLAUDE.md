...
- `public/js/state.js` the mutable UI state: the source filter, the term selection, the second figure's focused outlet, zoom, layout cache, request/abort bookkeeping.
